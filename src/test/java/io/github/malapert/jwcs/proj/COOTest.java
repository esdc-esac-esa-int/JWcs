...
public class COOTest extends AbstractProjectionTest {
    ...
    public COOTest() throws FitsException, IOException, JWcsException {
        super(new JWcsFits(new Fits(
                Objects.requireNonNull(COOTest.class.getClassLoader().getResource("1904-66_COO.fits")).toString())));
    }
    ...
    public void testProjectCOO() throws ProjectionException {
        ...
        final double[][] expectedResults =
                { { 266.447094172421544, -74.171522746884904 }, { 267.398028706357877, -60.210883825456492 },
                  { 294.059186487816874, -57.31359008331124 }, { 310.151814403167066, -69.453558019062982 } };
