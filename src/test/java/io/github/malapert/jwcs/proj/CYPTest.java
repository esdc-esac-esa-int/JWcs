...
public class CYPTest extends AbstractProjectionTest {
    ...
    public CYPTest() throws FitsException, IOException, JWcsException {
        super(new JWcsFits(new Fits(
                Objects.requireNonNull(CYPTest.class.getClassLoader().getResource("1904-66_CYP.fits")).toString())));
    }
    ...
    public void testProjectCYP() throws ProjectionException {
        ...
        final double[][] expectedResults =
                { { 263.6930064078756, -75.954802625117921 }, { 267.116502808782911, -57.996207756988362 },
                  { 294.107678006870742, -55.635186503469285 }, { 314.477005502137899, -70.787546551322961 } };
