...
public class MERTest extends AbstractProjectionTest {
    ...
    public MERTest() throws FitsException, IOException, JWcsException {
        super(new JWcsFits(new Fits(
                Objects.requireNonNull(MERTest.class.getClassLoader().getResource("1904-66_MER.fits")).toString())));
    }
    ...
    public void testProjectMER() throws ProjectionException {
        ...
        final double[][] expectedResults =
                { { 268.516280900495417, -73.380242883952121 }, { 269.134269245011296, -60.649380202768285 },
                  { 293.83175889042559, -58.42169429876801 }, { 307.13073648219023, -69.480771637250086 } };
