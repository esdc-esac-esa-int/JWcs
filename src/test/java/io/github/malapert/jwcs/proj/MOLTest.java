...
public class MOLTest extends AbstractProjectionTest {
    ...
    public MOLTest() throws FitsException, IOException, JWcsException {
        super(new JWcsFits(new Fits(
                Objects.requireNonNull(MOLTest.class.getClassLoader().getResource("1904-66_MOL.fits")).toString())));
    }
    ...
    public void testProjectMOL() throws ProjectionException {
        ...
        final double[][] expectedResults =
                { { 270.728461808021393, -74.169800730500654 }, { 270.397749810579967, -60.027188739395015 },
                  { 292.267963862224065, -57.664949584387834 }, { 306.844425277639289, -70.244628686944935 } };
