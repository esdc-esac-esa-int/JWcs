...
public class TPVTest extends AbstractProjectionTest {
    ...
    public TPVTest() throws FitsException, IOException, JWcsException {
        super(new JWcsFits(new Fits(Objects.requireNonNull(TPVTest.class.getClassLoader().getResource("tpv.fits")))));
    ...
    public void testProjectTPV() throws ProjectionException {
        ...
        final double[][] expectedResults =
                { { 52.53381848351462, -28.76060542329203 }, { 52.5332441513107, -28.746942356860124 },
                  { 52.54889662414678, -28.74710423659045 }, { 52.549452988200024, -28.760785077567455 } };
