...
public class STGTest extends AbstractProjectionTest {
    ...
    public STGTest() throws FitsException, IOException, JWcsException {
        super(new JWcsFits(new Fits(
                Objects.requireNonNull(STGTest.class.getClassLoader().getResource("1904-66_STG.fits")).toString())));
    }
    ...
    public void testProjectSTG() throws ProjectionException {
        ...
        final double[][] expectedResults =
                { { 269.37825680266144, -73.256130460250546 }, { 269.645741550822208, -61.036020984514579 },
                  { 292.979346455154086, -58.65820590406657 }, { 306.658467125869947, -69.210340276541672 } };
